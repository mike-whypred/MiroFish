<template>
  <div class="home-container">
    ...
    <nav class="navbar">
      ...
      <div class="nav-links">
        <router-link to="/brief-builder" class="nav-link">Brief Builder</router-link>
    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <div class="hero-desc">
            <p>
              With just a piece of text, <span class="highlight-bold">MiroFish</span> can extract reality seeds and automatically generate a parallel world composed of up to <span class="highlight-orange">millions of Agents</span>. Inject variables from a god's-eye view, and find <span class="highlight-code">"locally optimal solutions"</span> in complex group interactions within dynamic environments.
            </p>
            <p class="slogan-text">
              Let the future rehearse among Agents, let decisions triumph after battles<span class="blinking-cursor">_</span>
            </p>
          </div>
      ...
      <section class="dashboard-section">
        ...
        <div class="left-panel">
          ...
          <p class="section-desc">
            Prediction Engine Ready. Upload unstructured data to initialize the simulation sequence.
          </p>
            ...
            <div class="workflow-list">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Entity relation extraction & Persona generation & Agent environment configuration</div>
                </div>
              </div>
              <div class="workflow-item">
              ...
              <div class="workflow-item">
                ...
                <div class="step-info">
                  ...
                  <div class="step-desc">Dialogue with any agent in the simulated world & Interact with ReportAgent</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Enter your simulation or prediction requirements in natural language (e.g., What public opinion trends would emerge if the university releases a statement revoking the disciplinary action?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
